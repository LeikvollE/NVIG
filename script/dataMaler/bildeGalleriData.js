...
let bilder = [ //Linker til bildene i bildegalleriet.
    ...
    "Flagg/Russland.png","Flagg/Ukraina.png","Flagg/Tyskland.png","Flagg/Tyrkia.png",
    ...
    "Flagg/Vatikanstaten.png","Flagg/New_Zealand.png","Flagg/palestina.png"
];
let land = [ //Navnet på de ulike landene representert i galleriet.
    ...
    "Russland","Ukraina","Tyskland","Tyrkia",
    "Sverige","Sveits","Storbritania","Spania",
    "Sør Korea","Nepal","Qatar","Polen",
    "Vatikanstaten","New Zealand","Palestina"
];
...
let beskrivelser = [ //Linker til txt-filene som inneholder beskrivelsene til de ulike flaggene.
    ...
    "beskrivelser/Russland.txt","beskrivelser/Ukraina.txt","beskrivelser/Tyskland.txt","beskrivelser/Tyrkia.txt",
    ...
    "beskrivelser/Vatikanstaten.txt","beskrivelser/New_Zealand.txt","beskrivelser/palestina.txt"
];