var mainPhoto = {source:"bilder/artikkelTopp.png", alter:"artikkelbilde", heading:"Til alle med hjerte i NTNUI", intro:" - Jeg mener NTNUI bør redesigne flagget sitt."};
var details = {dato:"08/11/17",forfatter:"Frédéric Ménard Lindboe"};
var artikkelContent = [
    {type:"p",content:"\n" +
    "Jeg heter Frédéric, spiller volleyball for NTNUI og elsker flagg. Sistnevnte ble jeg av å ha sett " +
    ...
    "da jeg kommer til å ta utgangspunkt i sitater for å strukturere argumentene om <strong>hvorfor jeg mener NTNUI bør redesigne flagget sitt.</strong>"},
    ...
    {type:"p",content:"Gode flagg er anvendelige. Som vist over kan det norske flaggets fargemønster kan brukes på " +
    ...
    {type:"p",content:"Det er ikke bare nasjoner som bruker farger for å skape felleskap. Idrettsklubber gjør det" +
    ...
    "disse fargene. Dessverre, synes jeg, ser NTNUI-flagget i dag slik ut:"},
    ...
    {type:"p",content:"Jeg mener altså at flagget til NTNUI bør spille på abstrakt men assosiasjonsrik symbolikk. " +
    "Det trenger altså noe som skriker NTNUI men som ikke forteller det eksplisitt. Hvis det er utganspunktet blir " +
    ...
    "stripene i forhold til bunnen kan diskuteres, fargenyansen kan justeres, men hvordan kjernemotivet bør være er" +
    " for meg krystallklart. Jeg mener altså at det som skaper de sterkest assosiasjonene blir de beste symbolene. "},
    ...
    {type:"dobbelDiv",heading:"2. Use meaningful symbolism",
        ...
        "røde er i dag nesten ikke anvendt i NTNUIs fargeprofil og drakter så jeg tør påstå at veldig få " +
        ...
        "representerer disse tre fargene nå alle. "},
    ...
    {type:"dobbelDiv",heading:"4. No lettering or seals of any kind.",
        ...
        "Det er lite kraftig bruk av symbolikk og det er vanskelig å lese på avstand (kanskje ikke i dette tilfellet" +
        "siden NTNUI er skrevet så stort) og når flagget vaier speilvendt eller det ikke er vind. Klikk " +
        ...
        " vil det var gjenkjennelig som NTNUI-flagg både med og uten vind vaiende rettvendt eller speilvendt! Klikk " +
        "<a href='https://krikienoid.github.io/flagwaver/#?src=http%3A%2F%2Fi.imgur.com%2FKGIJ0oo.png' alt='flaggside' target='_blank'>her</a> " +
        "for å se hvordan dette flagget ser ut vaiende med og uten vind. Jeg mener dette flagget hadde vært mye " +
        "sterkere å bruke på flaggstanga til " +
    ...
    "et annet flagg. Jeg utfordrer deg til å prøve dette selv. "},
    {type:"img",source:"bilder/artikkelBilde11.png",alter:"Snap"},
    {type:"p",content:"Jeg kommer til å fremme et forslag om å få annerkjent dette stripeflagget som offisielt " +
    "NTNUI-flagg ved generalforsamling i februar 2018. Dersom du er NTNUI-medlem og enig i dette brevets " +
    "budskap håper jeg du vil stille opp for å stemme frem forslaget."},
    {type:"p",content:
